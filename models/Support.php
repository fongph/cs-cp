...
class Support extends \System\Model {
    ...
    public function submitTicket($name, $email, $type, $message) {
        ...
        return $this->sendTicket($name, $email, $this->di['t']->_(self::$types[$type]), $message);
    }
    ...
    public function sendTicket($name, $email, $type, $message) {
        ...
        $mailModel->sendSupportTicket($number, $name, $email, $type, $message, $info['browser'], $info['os']);
...
class SupportInvalidEmailException extends \Exception {
    
}

class SupportInvalidTypeException extends \Exception {
    
}

class SupportEmptyFieldException extends \Exception {
