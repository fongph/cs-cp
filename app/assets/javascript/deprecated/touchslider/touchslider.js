    ...
    createSlidePanel: function(/*string*/ gridid, /*int*/ cellWidth, /*int*/ padding) {
        ...
        $(gridid).each(function() {
            ...
            try {
                 ...
                 */
                var _h = $('.table-container thead th').length * 35;
                $(this).css({
                    'height': _h +'px',
                    'overflow': 'auto'
                });
...
//    alert('BLAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');
//    console.log('Init: touchslider!');
//    touchslider.createSlidePanel('.table-container tbody', 200, 15);
});
