  ...
  // Finally, as a browser global.
    ...
    DateRangePicker.prototype = {
        ...
        updateMonthsInView: function() {
            if (this.endDate) {
                ...
                if (this.startDate === null) {
                    ...
                    this.rightCalendar.month = moment().clone().date(2).add(1, 'month');
                } else {
        ...
        updateFormInputs: function() {
            ...
            if (this.singleDatePicker || (this.startDate && this.endDate && (this.startDate.isBefore(this.endDate) || this.startDate.isSame(this.endDate)))) {
        ...
        clickDate: function(e) {
            ...
            //
            if (this.endDate !== null || this.startDate === null || date.isBefore(this.startDate)) {
                if (this.timePicker) {
